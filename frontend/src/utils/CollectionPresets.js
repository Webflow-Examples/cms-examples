    ...
    },
    {
      ...
      collection: {
        ...
        fields: [
          ...
          {name: 'Client', type: 'PlainText', validations: {singleLine: true}},
    ...
    },
    {
      ...
      collection: {
        ...
        fields: [
          ...
          {name: 'Job Title', type: 'PlainText', validations: {singleLine: true}},
          {name: 'Email', type: 'Email'},
          {name: 'Phone Number', type: 'Phone'},
          {name: 'Twitter Link', type: 'Link'},
          {name: 'Facebook Link', type: 'Link'},
    ...
    },
    {
      ...
      collection: {
        ...
        fields: [
          ...
          {name: 'Location', type: 'PlainText', validations: {singleLine: true}},
    ...
    },
    {
      ...
      collection: {
        ...
        fields: [
          ...
          {name: 'Country', type: 'PlainText', validations: {singleLine: true}},
          {name: 'Location', type: 'PlainText', validations: {singleLine: true}},
...
const collectionPresets = webflowCollectionPresets.map(preset => ({
    ...
    collection: {
        ...
        fields: preset.collection.fields.map(field => ({
            ...field,  // Spread existing field properties
            displayName: field.name,  // Add new displayName property
            name: undefined,  // Remove the name property by setting it to undefined
            validations: undefined // Remove the validations property by setting it to undefined
        })).map(({ name, validations, ...rest }) => rest)  // Remove the name property from the final objects
    }
}));
